        ...
        function renderCertCards() {
            ...
            certData.slice(0, 6).forEach(function(c) {
                ...
                div.innerHTML =
                    '<div class="cert-icon-wrap" style="background-image:url(\'' + c.image + '\');background-size:cover;background-position:center;border-radius:10px;"></div>' +
        ...
        function buildSlide(c) {
            ...
            div.innerHTML = 
                '<div class="cert-slide-inner" style="background-image:url(\'' + c.image + '\');background-size:cover;background-position:center;">' +
